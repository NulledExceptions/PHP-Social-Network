...
<head>
	...
	<script type="text/javascript" src="js/wallfunctions.js"></script>
...
$(document).ready(function() {
	...
	$("#searchinput").click(function () {
		$("#searchresult").toggle(300);
	});		
	$("#closeSearch").click(function () {
		$("#allResults").close(300);
	});				
});
</script>
  ...
  <div id="homeContent">
	...
	<div id="wall_container">
      <div id="updateboxarea">
        <form name="inputbox"> 
			<table class="inputiconrow">
			  <tr>
				<td class="inputicon" id="whatup" onmouseover="popup('Say What's Up')" onmouseout="kill()"></td>
				<td class="inputicon" id="image" onclick="document.getElementById('input_tb').style.visibility='hidden';document.getElementById('imageupload').style.visibility='visible'" onmouseover="popup('Upload an Image')" onmouseout="kill()"></td>
				<td class="inputicon" id="video" onmouseover="popup('Upload a Video')" onmouseout="kill()"></td>
				<td class="inputicon" id="link" onmouseover="popup('Insert a Link')" onmouseout="kill()"></td>
				<td class="inputicon" id="location" onmouseover="popup('View Locations')" onmouseout="kill()"></td>
				<td class="inputicon" id="event" onmouseover="popup('Local Events')" onmouseout="kill()"></td>
				<td class="inputicon" id="settings" onmouseover="popup('Modify Settings')" onmouseout="kill()"></td>
			  </tr>
		    </table>
			
			<!-- Each Div is For Different Uploads-->
			  <!-- This div handles the 'What's Up' Update functions -->
	        <div id="input_tb">
			  ...
			  <!-- Image Upload -->
			<div id="imageupload" class="border" style="visibility:hidden">
			  <form id="imageform" method="post" enctype="multipart/form-data" action='image_ajax.php'>
				<input type="text" name="update" id="update" value="Upload an image" onclick="this.form.photoimg.click()" onblur="this.form.photoimg.click()">
				<input type="file" name="photoimg" id="photoimg" value="" onblur="this.form.uploadvalues.click()" style="visibility:hidden;">
				<input type='submit' id='uploadvalues' style="visibility:hidden" onclick="this.form.update_button.click()"/>
				<input type="submit"  value=" Update "  id="update_button"  class="update_button" style="visibility:hidden"/>
			  </form>
			</div>
		</form>
...
<!-- Hidden Div Displays Search Results Only -->
<div id="allresults" onmouseover="document.getElementById('searchresults_x').style.display='block'" onmouseout="document.getElementById('searchresults_x').style.display='none'">
<div id="searchresult">
 <div class="headerwrapper"><div id="searchheader"></div>
   <div id="searchresults_x"><button type="button" name="searchresults_x" id="closeSearch" class="sResults_x" onclick="close_sResults()"></button></div>
 </div>
    <div id="searchbg">
	  <div class="sResult">
	    <div class="sResultpic">
			
		</div>
		<div class="sResultnfo">
		  <table>
		    <tr>
			  <td> License Plate: <!-- Echo users license plate number here --> </td>
			</tr>
			<tr>
			  <td> State: <!-- Echo users state here --></td>
			</tr>
			<tr>
			  <td> Name: <!-- Echo users first and last name here --></td>
			</tr>
			<tr>
			  <td> Car: <!-- Echo users make and model of car --></td>
			</tr>
			<tr>
			  <td> Year/Color: <!-- Echo users year and car color --></td>
			</tr>
	      </table>
			  
		</div>
		<div class="sResultplate">

  ...
  <div id="adheader">
   ...
   <div id="ad2">
     ...
     <div id="ad2h">
		...
		<textarea id="ad2_tb" value="Enter the body of your ad" onclick="if(this.value=='Enter the body of your ad'){this.value=''}" 
		                                                                 onblur="if(this.value==''){this.value='Enter the body of your ad'};
																		         body_display()"></textarea>
     </div>
   ...
   <div id="ad3">
     ...
     <div id="ad3h">
		...
		<form id="file_upload" method="POST" enctype="multipart/form-data" action="ajaxupload.php">
   ...
   <!--Functions which change frames I.E. PPC_frameV (stands for pay per click Visible) or PPC_frameH (Pay Per Click Hidden) can be found in the js folder under the file frames.js-->

  ...
  <div class="sidebar1">
    <div class="infopanel">
      ...
      <div class="iconpanel">
           <div class="icons">
             <div class="row">
               <a href="profile_body.php"><img src="images/home_icons/Profile.png" class="home_icon" onmouseover="popup('Profile')" onmouseout="kill()" /></a>
...
<?php 
// Loading Messages
include('load_messages_global.php'); 
?>
  ...
  <div class="sidebar2">
    <div class="searchform">
	  ...
	  <div class="searchbar">
	    <form method="post" action="<? echo $_SERVER['PHP_SELF']; ?>" onsubmit="showsearch()">
